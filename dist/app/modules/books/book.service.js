...
const createReadingList = (BookData) => __awaiter(void 0, void 0, void 0, function* () {
    const { title, author } = BookData;
    const existingWishlist = yield readinglist_model_1.default.findOne({ title, author });
    if (existingWishlist) {
        throw new ApiError_1.default(409, "Already exist in Reading List");
    }
    const newWishlist = yield readinglist_model_1.default.create(BookData);
    return newWishlist;
});
...
const getReadingList = () => __awaiter(void 0, void 0, void 0, function* () {
    const books = yield readinglist_model_1.default.find();
    return books;
});
...
const removeFromReadingList = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield readinglist_model_1.default.findByIdAndDelete(id);
    return result;
});
